...
func (q *Queries) GetEntriesByAccountId(ctx context.Context, accountID int64) ([]Entries, error) {
...
func (q *Queries) GetEntriesByDateRange(ctx context.Context, arg GetEntriesByDateRangeParams) ([]Entries, error) {
	rows, err := q.db.QueryContext(ctx, getEntriesByDateRange, arg.AccountID, arg.CreatedAt, arg.CreatedAt_2)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) ListEntriesAll(ctx context.Context, arg ListEntriesAllParams) ([]Entries, error) {
	rows, err := q.db.QueryContext(ctx, listEntriesAll, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
