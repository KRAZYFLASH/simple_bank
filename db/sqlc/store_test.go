...
func TestTransferTx(t *testing.T) {
	...
	for i := 0; i < n; i++ {
		...
		// Cek entri dari akun yang mengirim
		...
		// Cek entri dari akun yang menerima
		...
		// TODO: Cek perubahan saldo
		fmt.Println(">> tx:", fromAccount.Balance, toAccount.Balance)
		diff1 := account1.Balance - fromAccount.Balance
		diff2 := toAccount.Balance - account2.Balance
		require.Equal(t, diff1, diff2)
		require.True(t, diff1 > 0)
		require.True(t, diff1%amount == 0) // karena nilai transfernya kelipatan amount, contoh: seperti penjumlahan 10+10+10

		// Cek berapa kali transfer telah dilakukan
		k := int(diff1 / amount)
